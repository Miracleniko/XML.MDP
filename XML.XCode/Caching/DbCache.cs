...
public class DbCache : Core.Caching.Cache
{
    #region 属性
    ...
    public override void Init(String config)
    {
        ...
        {
            var period = 60;
            clearTimer = new TimerEV(RemoveNotAlive, null, period * 1000, period * 1000) { Async = true };
        }
    }
    ...
    public override Boolean Set<T>(String key, T value, Int32 expire = -1)
    {
        ...
        e.ExpiredTime = TimerEV.Now.AddSeconds(expire);

        if (e.CreateTime.Year < 2000) e.CreateTime = TimerEV.Now;
        e.SaveAsync();
    ...
    public override Boolean SetExpire(String key, TimeSpan expire)
    {
        ...
        e.ExpiredTime = TimerEV.Now.Add(expire);
        e.SaveAsync();
    ...
    public override TimeSpan GetExpire(String key)
    {
        ...
        return e.ExpiredTime - TimerEV.Now;
    }
    #endregion
