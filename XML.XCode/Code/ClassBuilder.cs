...
public class ClassBuilder
{
    ...
    public static IList<IDataTable> LoadModels(String xmlFile, BuilderOption option, out IDictionary<String, String> atts)
    {
        ...
        {
            ["xmlns"] = "https://data.xmoonlight.com/Model2022.xsd",
            ["xmlns:xs"] = "http://www.w3.org/2001/XMLSchema-instance",
            ["xs:schemaLocation"] = "https://data.xmoonlight.com https://data.xmoonlight.com/Model2022.xsd"
        };
    ...
    protected virtual void OnExecuting()
    {
        ...
        if (Option.Extend && !us.Contains("XML.XCode.Data")) us.Add("XML.XCode.Data");
