...
public class Setting : Config<Setting>
{
    ...
    /// <summary>资源地址。指向CDN，留空表示使用本地</summary>
    [Description("资源地址。指向CDN，留空表示使用本地")]
    [Category("通用")]
    ...
    /// <summary>平台Web。平台控制台地址，支持直达调用链 /trace?id={traceId} 或 /graph?id={traceId}</summary>
    [Description("平台Web。平台控制台地址，支持直达调用链 /trace?id={traceId} 或 /graph?id={traceId}")]
    [Category("界面配置")]
