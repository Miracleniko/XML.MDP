...
/// </remarks>
public class TimerEV : IDisposable
{
    #region 属性
    /// <summary>编号</summary>
    ...
    #region 静态
    private static readonly AsyncLocal<TimerEV?> _Current = new();
    /// <summary>当前定时器</summary>
    public static TimerEV? Current { get => _Current.Value; set => _Current.Value = value; }
    #endregion

    #region 构造
    private TimerEV(Object? target, MethodInfo method, Object? state, String? scheduler = null)
    {
    ...
    public TimerEV(TimerCallback callback, Object? state, Int32 dueTime, Int32 period, String? scheduler = null) : this(callback.Target, callback.Method, state, scheduler)
    {
    ...
    /// <param name="period">间隔周期。毫秒</param>
    /// <param name="scheduler">调度器</param>
    public TimerEV(Func<Object, Task> callback, Object? state, Int32 dueTime, Int32 period, String? scheduler = null) : this(callback.Target, callback.Method, state, scheduler)
    {
        if (callback == null) throw new ArgumentNullException(nameof(callback));
        if (dueTime < 0) throw new ArgumentOutOfRangeException(nameof(dueTime));
    ...
    /// <param name="period">间隔周期。毫秒</param>
    /// <param name="scheduler">调度器</param>
    public TimerEV(TimerCallback callback, Object state, DateTime startTime, Int32 period, String? scheduler = null) : this(callback.Target, callback.Method, state, scheduler)
    {
        if (callback == null) throw new ArgumentNullException(nameof(callback));
    ...
    /// <param name="period">间隔周期。毫秒</param>
    /// <param name="scheduler">调度器</param>
    public TimerEV(Func<Object, Task> callback, Object state, DateTime startTime, Int32 period, String? scheduler = null) : this(callback.Target, callback.Method, state, scheduler)
    {
        if (callback == null) throw new ArgumentNullException(nameof(callback));
        if (startTime <= DateTime.MinValue) throw new ArgumentOutOfRangeException(nameof(startTime));
        if (period <= 0) throw new ArgumentOutOfRangeException(nameof(period));
    ...
    /// <param name="scheduler">调度器</param>
    public TimerEV(TimerCallback callback, Object state, String cronExpression, String? scheduler = null) : this(callback.Target, callback.Method, state, scheduler)
    {
        if (callback == null) throw new ArgumentNullException(nameof(callback));
    ...
    /// <param name="cronExpression">Cron表达式</param>
    /// <param name="scheduler">调度器</param>
    public TimerEV(Func<Object, Task> callback, Object state, String cronExpression, String? scheduler = null) : this(callback.Target, callback.Method, state, scheduler)
    {
        if (callback == null) throw new ArgumentNullException(nameof(callback));
        if (cronExpression.IsNullOrEmpty()) throw new ArgumentNullException(nameof(cronExpression));
    ...
    /// <param name="ms"></param>
    /// <returns></returns>
    public static TimerEV Delay(TimerCallback callback, Int32 ms) => new(callback, null, ms, 0) { Async = true };

    private static TimerEV? _NowTimer;
            ...
            if (_NowTimer == null)
            {
                lock (TimerScheduler.Default)
                {
                    if (_NowTimer == null)
                    {
                        ...
                        _NowTimer = new TimerEV(CopyNow, null, 0, 500);
                    }
                }
            }
